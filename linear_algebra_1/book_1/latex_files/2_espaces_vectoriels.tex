...
Deux vecteurs a et b (ou plus) sont independants si on peut trouver des coefficients de combinaisons \textbf{non egaux a 0} tel que $\alpha*a + \beta*b = \textbf{0}$. Si les scalaires sont 0 alors les vecteurs ne sont pas independants ( \cjRL{tlwy lyn'ryt} ). \\
